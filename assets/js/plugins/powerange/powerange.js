 ...
 *     });
    ...
    require.register("powerange/lib/main.js", function(exports, require, module){
        ...
        Powerange.prototype.setValue = function (offset, size) {
            ...
            currentValueNode = this.element.parentNode.children[1].children[4];
            currentValueNode.innerHTML = value;
            currentValueNode.setAttribute('style', 'position: absolute; left: ' + (this.element.parentNode.children[1].children[3].offsetWidth - 40)  + 'px; top: 5px; font-weight: 600;');
    ...
    require.register("powerange/lib/horizontal.js", function(exports, require, module){
        ...
        Horizontal.prototype.setPosition = function(val) {
            ...
            this.slider.querySelector('.range-quantity').style.width = (val + this.handle.offsetWidth) +  'px';
        };
